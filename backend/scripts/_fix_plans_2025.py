...
现 plans_2025 仅剩广东(4970)+甘肃(4571)。为有 plans_2026 但无 plans_2025 的省份反向生成。
...
适用省份：福建/安徽（有 plans_2026 且数据量足够）
"""
import os
import pandas as pd
...
print("=" * 60)
print("[#19] plans_2025 多省恢复")
print("=" * 60)

# 有 plans_2026 但无 plans_2025 的省份
for prov in ["福建", "安徽"]:
    ...
    p25 = p26.copy()
    p25["plan_count"] = p26["plan_count_prev"].fillna(p26["plan_count"])
